#!/usr/bin/env python3
"""
build_gas.py — Bundles docs/ into self-contained HTML files under gas/, ready
to push to Google Apps Script with clasp.

Apps Script cannot serve static files, so CSS, JS and the tariffs are inlined
into each page. data/ remains the single source of truth.
...
def inline(html, tariffs):
    ...
    # Swap the fetch-based loader for the inlined bundle
    ...
    # Internal links become doGet parameters
...
def main():
    ...
    print("\nDone. Next: cd gas && clasp push && clasp deploy")
